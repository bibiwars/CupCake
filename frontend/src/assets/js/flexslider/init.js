        ...
        if ($().flexslider) {
            ...
            if ($(".ct-js-flexslider").length > 0) {
                $(".ct-js-flexslider").each(function () {
                    ...
                    var $this = $(this);
                    var $button = $this.find(".ct-js-flexslider-togglePlay");
                    ...
                    var ctslideshowspeed = parseInt(validatedata($this.attr("data-slideshowspeed"), 6000));
                    ...
                    if($devicewidth < 480 || device.mobile()){
                        ctitemmargin = 0;
                    }
